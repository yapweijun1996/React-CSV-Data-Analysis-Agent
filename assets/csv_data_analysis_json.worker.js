...
class Emitter {
  constructor(options) {
    ...
    this._leakageMon = ((_a2 = this._options) == null ? void 0 : _a2.leakWarningThreshold) ? new LeakageMonitor((options == null ? void 0 : options.onListenerError) ?? onUnexpectedError, ((_b2 = this._options) == null ? void 0 : _b2.leakWarningThreshold) ?? _globalLeakWarningThreshold) : void 0;
    this._perfMon = ((_c3 = this._options) == null ? void 0 : _c3._profName) ? new EventProfiling(this._options._profName) : void 0;
    this._deliveryQueue = (_d2 = this._options) == null ? void 0 : _d2.deliveryQueue;
  }
  dispose() {
    var _a2, _b2, _c3, _d2;
    if (!this._disposed) {
      ...
      (_c3 = (_b2 = this._options) == null ? void 0 : _b2.onDidRemoveLastListener) == null ? void 0 : _c3.call(_b2);
  ...
  get event() {
    this._event ?? (this._event = (callback, thisArgs, disposables) => {
      var _a2, _b2, _c3, _d2, _e2, _f2, _g;
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        const message = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`;
        console.warn(message);
        const tuple = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1];
        const error = new ListenerRefusalError(`${message}. HINT: Stack shows most frequent listener (${tuple[1]}-times)`, tuple[0]);
        const errorHandler2 = ((_a2 = this._options) == null ? void 0 : _a2.onListenerError) || onUnexpectedError;
        errorHandler2(error);
      ...
      if (!this._listeners) {
        (_c3 = (_b2 = this._options) == null ? void 0 : _b2.onWillAddFirstListener) == null ? void 0 : _c3.call(_b2, this);
        this._listeners = contained;
        (_e2 = (_d2 = this._options) == null ? void 0 : _d2.onDidAddFirstListener) == null ? void 0 : _e2.call(_d2, this);
      ...
      (_g = (_f2 = this._options) == null ? void 0 : _f2.onDidAddListener) == null ? void 0 : _g.call(_f2, this);
      this._size++;
  ...
  _removeListener(listener) {
    ...
    if (this._size === 1) {
      this._listeners = void 0;
      (_d2 = (_c3 = this._options) == null ? void 0 : _c3.onDidRemoveLastListener) == null ? void 0 : _d2.call(_c3, this);
      this._size = 0;
      return;
    }
  ...
  fire(event) {
    ...
    if ((_a2 = this._deliveryQueue) == null ? void 0 : _a2.current) {
      ...
      (_b2 = this._perfMon) == null ? void 0 : _b2.stop();
    }
    (_c3 = this._perfMon) == null ? void 0 : _c3.start(this._size);
    if (!this._listeners) ;
    else if (this._listeners instanceof UniqueContainer) {
...
function lookupMessage(index, fallback) {
  var _a2;
  const message = (_a2 = getNLSMessages()) == null ? void 0 : _a2[index];
...
if (typeof nodeProcess === "object") {
  ...
  if (rawNlsConfig) {
    try {
      ...
      _translationsConfigFile = (_c2 = nlsConfig.languagePack) == null ? void 0 : _c2.translationsConfigFile;
    } catch (e) {
    }
  }
  ...
  (_userAgent == null ? void 0 : _userAgent.indexOf("Mobi")) >= 0;
...
function commonPrefixLength(a2, b) {
  const len = Math.min(a2.length, b.length);
  let i;
  for (i = 0; i < len; i++) {
    if (a2.charCodeAt(i) !== b.charCodeAt(i)) {
      return i;
    }
  }
  return len;
}
function commonSuffixLength(a2, b) {
  const len = Math.min(a2.length, b.length);
  let i;
  const aLastIndex = a2.length - 1;
  const bLastIndex = b.length - 1;
  for (i = 0; i < len; i++) {
    if (a2.charCodeAt(aLastIndex - i) !== b.charCodeAt(bLastIndex - i)) {
      return i;
    }
  }
  return len;
...
let Range$1 = class Range {
   ...
   */
  static areOnlyIntersecting(a2, b) {
    if (a2.endLineNumber < b.startLineNumber - 1 || a2.endLineNumber === b.startLineNumber && a2.endColumn < b.startColumn - 1) {
      return false;
    }
    if (b.endLineNumber < a2.startLineNumber - 1 || b.endLineNumber === a2.startLineNumber && b.endColumn < a2.startColumn - 1) {
      return false;
    }
    return true;
  }
...
} else if (typeof process !== "undefined" && typeof ((_d = process == null ? void 0 : process.versions) == null ? void 0 : _d.node) === "string") {
  safeProcess = {
    get platform() {
...
class TokenizationRegistry {
  ...
  registerFactory(languageId, factory) {
    var _a2;
    (_a2 = this._factories.get(languageId)) == null ? void 0 : _a2.dispose();
...
let FoldingRangeKind$1 = (_e = class {
  /**
...
}, _e.Comment = new _e("comment"), _e.Imports = new _e("imports"), _e.Region = new _e("region"), _e);
...
class DetailedLineRangeMapping extends LineRangeMapping {
  ...
  flip() {
    var _a2;
    return new DetailedLineRangeMapping(this.modified, this.original, (_a2 = this.innerChanges) == null ? void 0 : _a2.map((c) => c.flip()));
  }
...
function lineRangeMappingFromRangeMappings(alignments, originalLines, modifiedLines, dontAssertStartLine = false) {
  const changes = [];
  for (const g of groupAdjacentBy(alignments.map((a2) => getLineRangeMapping(a2, originalLines, modifiedLines)), (a1, a2) => a1.original.intersectsOrTouches(a2.original) || a1.modified.intersectsOrTouches(a2.modified))) {
    const first = g[0];
...
let Color$1 = (_f = class {
  static fromHex(hex) {
    return _f.Format.CSS.parseHex(hex) || _f.red;
  }
  static equals(a2, b) {
    if (!a2 && !b) {
      return true;
  ...
  getRelativeLuminance() {
    const R = _f._relativeLuminanceForComponent(this.rgba.r);
    const G = _f._relativeLuminanceForComponent(this.rgba.g);
    const B = _f._relativeLuminanceForComponent(this.rgba.b);
  ...
  lighten(factor) {
    return new _f(new HSLA(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * factor, this.hsla.a));
  }
  darken(factor) {
    return new _f(new HSLA(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * factor, this.hsla.a));
  }
  transparent(factor) {
    ...
    return new _f(new RGBA(r, g, b, a2 * factor));
  }
  isTransparent() {
  ...
  opposite() {
    return new _f(new RGBA(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  /**
  ...
  mix(color, factor = 0.5) {
    ...
    const a2 = thisRGBA.a + (otherRGBA.a - thisRGBA.a) * normalize;
    return new _f(new RGBA(r, g, b, a2));
  }
  makeOpaque(opaqueBackground) {
    ...
    const { r, g, b, a: a2 } = this.rgba;
    return new _f(new RGBA(opaqueBackground.rgba.r - a2 * (opaqueBackground.rgba.r - r), opaqueBackground.rgba.g - a2 * (opaqueBackground.rgba.g - g), opaqueBackground.rgba.b - a2 * (opaqueBackground.rgba.b - b), 1));
  }
  toString() {
    if (!this._toString) {
      this._toString = _f.Format.CSS.format(this);
    }
...
}, _f.white = new _f(new RGBA(255, 255, 255, 1)), _f.black = new _f(new RGBA(0, 0, 0, 1)), _f.red = new _f(new RGBA(255, 0, 0, 1)), _f.blue = new _f(new RGBA(0, 0, 255, 1)), _f.green = new _f(new RGBA(0, 255, 0, 1)), _f.cyan = new _f(new RGBA(0, 255, 255, 1)), _f.lightgrey = new _f(new RGBA(211, 211, 211, 1)), _f.transparent = new _f(new RGBA(0, 0, 0, 0)), _f);
(function(Color2) {
  (function(Format) {
    (function(CSS) {
      ...
      function parse2(css) {
        ...
        if (css.startsWith("rgba(")) {
          ...
          const r = parseInt(((_a2 = color.groups) == null ? void 0 : _a2.r) ?? "0");
          const g = parseInt(((_b2 = color.groups) == null ? void 0 : _b2.g) ?? "0");
          const b = parseInt(((_c3 = color.groups) == null ? void 0 : _c3.b) ?? "0");
          const a2 = parseFloat(((_d2 = color.groups) == null ? void 0 : _d2.a) ?? "0");
          return new Color2(new RGBA(r, g, b, a2));
        }
        if (css.startsWith("rgb(")) {
          ...
          const r = parseInt(((_e2 = color.groups) == null ? void 0 : _e2.r) ?? "0");
          const g = parseInt(((_f2 = color.groups) == null ? void 0 : _f2.g) ?? "0");
          const b = parseInt(((_g = color.groups) == null ? void 0 : _g.b) ?? "0");
...
function findSectionHeaders(model, options) {
  var _a2;
  let headers = [];
  if (options.findRegionSectionHeaders && ((_a2 = options.foldingRules) == null ? void 0 : _a2.markers)) {
...
class DeferredPromise {
  get isRejected() {
    var _a2;
    return ((_a2 = this.outcome) == null ? void 0 : _a2.outcome) === 1;
  }
  get isSettled() {
    return !!this.outcome;
  }
...
const _AsyncIterableProducer = class _AsyncIterableProducer {
  constructor(executor, _onReturn) {
    ...
    this._iterator = {
      ...
      return: () => {
        var _a2;
        (_a2 = this._onReturn) == null ? void 0 : _a2.call(this);
  ...
  static computeDiff(originalTextModel, modifiedTextModel, options, algorithm) {
    ...
    function getLineChanges(changes) {
      return changes.map((m) => {
        var _a2;
        return [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, (_a2 = m.innerChanges) == null ? void 0 : _a2.map((m2) => [
...
function validate(n, schema, validationResult, matchingSchemas, context) {
  ...
  function _validateNode() {
    ...
    if (deprecationMessage || schema.deprecated) {
      ...
      let targetNode = ((_a2 = node.parent) == null ? void 0 : _a2.type) === "property" ? node.parent : node;
      validationResult.problems.push({
  ...
  function _validateNumberNode(node2) {
    ...
    function normalizeFloats(float) {
      ...
      return parts && {
        ...
        multiplier: (((_a2 = parts[2]) == null ? void 0 : _a2.length) || 0) - (parseInt(parts[3]) || 0)
      };
    }
...
class JSONCompletion {
  ...
  evaluateSeparatorAfter(document2, offset) {
    const scanner = createScanner(document2.getText(), true);
  ...
  isInComment(document2, start2, offset) {
    const scanner = createScanner(document2.getText(), false);
  ...
  doesSupportMarkdown() {
    ...
    if (!isDefined(this.supportsMarkdown)) {
      const documentationFormat = (_c3 = (_b2 = (_a2 = this.clientCapabilities.textDocument) == null ? void 0 : _a2.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c3.documentationFormat;
  ...
  doesSupportsCommitCharacters() {
    ...
    if (!isDefined(this.supportsCommitCharacters)) {
      this.labelDetailsSupport = (_c3 = (_b2 = (_a2 = this.clientCapabilities.textDocument) == null ? void 0 : _a2.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c3.commitCharactersSupport;
    }
  ...
  doesSupportsLabelDetails() {
    ...
    if (!isDefined(this.labelDetailsSupport)) {
      this.labelDetailsSupport = (_c3 = (_b2 = (_a2 = this.clientCapabilities.textDocument) == null ? void 0 : _a2.completion) == null ? void 0 : _b2.completionItem) == null ? void 0 : _c3.labelDetailsSupport;
    }
...
class JSONSchemaService {
  ...
  getSchemaFromProperty(resource, document2) {
    var _a2, _b2;
    if (((_a2 = document2.root) == null ? void 0 : _a2.type) === "object") {
      for (const p of document2.root.properties) {
        if (p.keyNode.value === "$schema" && ((_b2 = p.valueNode) == null ? void 0 : _b2.type) === "string") {
...
function getSelectionRanges(document2, positions, doc) {
  ...
  function newRange(start2, end) {
    return Range2.create(document2.positionAt(start2), document2.positionAt(end));
  }
  const scanner = createScanner(document2.getText(), true);
...
function findLinks(document2, doc) {
  ...
  doc.visit((node) => {
    var _a2;
    if (node.type === "property" && node.keyNode.value === "$ref" && ((_a2 = node.valueNode) == null ? void 0 : _a2.type) === "string") {
...
function getLanguageService(params) {
  ...
  return {
    configure: (settings) => {
      ...
      (_a2 = settings.schemas) == null ? void 0 : _a2.forEach(jsonSchemaService.registerExternalSchema.bind(jsonSchemaService));
      jsonValidation.configure(settings);
    },
    resetSchema: (uri) => jsonSchemaService.onResourceChange(uri),
    doValidation: jsonValidation.doValidation.bind(jsonValidation),
    getLanguageStatus: jsonValidation.getLanguageStatus.bind(jsonValidation),
    parseJSONDocument: (document2) => parse(document2, { collectComments: true }),
    ...
    findLinks,
    format: (document2, range, options) => format(document2, options, range),
